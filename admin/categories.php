  ...
  <body>
    ...
    <div class="container-fluid wapper px-0">
      <div class="row p2 ms-auto">
        <div class="col ">
            <h2 class="fw-bold fs-3 mb-4">Manage Category</h2>
          <div class="">  
              ...
              <table class="table table-borderless">
                  ...
                  <tbody>
                      <tr class="">
                          ...
                          <td class="w-25 align-middle">Pizza</td>
                          <td class="col-2">
                          ...
                          <a href="#" class="btn-update btn  btn-primary p-0 ">Update Category</a>
                          <a href="#" class="btn-delete btn  btn-primary p-0 ">Delete Category</a>
                          </td>
                      </tr>
                      <tr class="">
                        <td scope="row border-bottom-0 " class="align-middle">2.</th>
                          <td class="w-25 align-middle">Burger</td>
                          <td>
                      ...
                      <tr class="">
                          ...
                          <td class="w-25 align-middle">Momo</td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                            <img src="images/img1.png" alt="" class="w-50 img-dt">
                          </td>
                          <td class="align-middle">Yes</td>
                          <td class="align-middle">Yes</td>
                          <td class="align-middle">
